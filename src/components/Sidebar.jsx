...
const NAV_ITEMS = [
  {
    id: 'home',
    label: 'Home',
    caption: 'Curated spotlight',
    icon: HomeIcon,
  },
  {
    id: 'movies',
    label: 'Movies',
    caption: 'Blockbusters & indies',
    icon: FilmIcon,
  },
  {
    id: 'series',
    label: 'Series',
    caption: 'Binge-ready episodes',
    icon: TvIcon,
  },
  {
    id: 'new',
    label: 'New & Hot',
    caption: 'Fresh releases',
    icon: SparklesIcon,
  },
  {
    id: 'watchlist',
    label: 'Watchlist',
    caption: 'Saved titles',
    icon: BookmarkIcon,
  },
];
        ...
        <div className="hidden items-center gap-3 overflow-hidden md:flex md:w-full md:max-w-0 md:opacity-0 md:transition-all md:duration-300 md:group-hover/sidebar:max-w-48 md:group-hover/sidebar:opacity-100">
          ...
          <div className="min-w-0">
            <div className="truncate text-sm font-medium text-white">
              {session?.displayName || 'Guest Session'}
            </div>
            <div className="truncate text-[11px] uppercase tracking-[0.2em] text-white/45">
              {session ? 'Firebase account' : 'Local cache'}
            </div>
          </div>
        </div>
      </aside>
